...
def upgrade():
    if not _table_exists("document_extractions"):
        op.create_table(
    ...
    if not _index_exists("document_extractions", "ix_document_extractions_document_id"):
        op.create_index("ix_document_extractions_document_id", "document_extractions", ["document_id"])
    if not _index_exists("document_extractions", "ix_document_extractions_status"):
        op.create_index("ix_document_extractions_status", "document_extractions", ["status"])

    if not _table_exists("document_verifications"):
        op.create_table(
    ...
    if not _index_exists("document_verifications", "ix_document_verifications_document_id"):
        op.create_index("ix_document_verifications_document_id", "document_verifications", ["document_id"])

    if not _table_exists("vehicle_intelligence"):
        op.create_table(
    ...
    if not _index_exists("vehicle_intelligence", "ix_vehicle_intelligence_registration_number"):
