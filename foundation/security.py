...
def seed_rbac():
    ...
    permissions = [
        ...
        ("agents:write", "Create/update agent records"),
        ...
        ("renewals:read", "Read renewals"),
        ("renewals:write", "Create/update renewals"),
        ("reports:read", "Read reports"),
        ("admin:manage", "Manage platform configuration"),
    ]
    ...
    for role_name, codes in role_permissions.items():
        ...
        role.permissions = [permission_map[c] for c in codes]
