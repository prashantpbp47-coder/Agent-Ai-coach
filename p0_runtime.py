...
from foundation import register_foundation, register_p1_domains, register_p2_quote_bridge

# Preserve legacy routes and add the authenticated P0/P1/P2 platform APIs.
