...
from foundation import (
    register_foundation, register_p1_domains, register_p2_quote_bridge, register_p3_providers,
    register_p4_rm_command_center, register_p5_rm_planner, register_p6_agent_inbox,
    register_p7_rm_target_marketing, register_p8_messaging, register_p9_document_intelligence,
    register_p10_followup_renewal, register_p11_automation_bi, register_p12_clay_prospect_intelligence,
    register_p13_bi_reconciliation, register_p14_adaptive_targets, register_p15_priya_ai,
)

# Preserve legacy routes and add the authenticated P0-P15 platform APIs.
